		...
		<div>
			...
			<section className='bg-slate-900 text-white py-20'>
				<div className='container mx-auto px-4'>
					...
					<p className='text-xl text-blue-100 max-w-3xl'>
						Tell us about your requirements and we'll provide a
			...
			<div className='container mx-auto px-4 py-16'>
				<div className='max-w-3xl mx-auto'>
					{/* Benefits Section */}
					<div className='bg-blue-50 border border-blue-200 rounded-lg p-6 mb-8 text-black'>
						...
						<ul className='space-y-2'>
							<li className='flex items-start gap-2'>
								...
								/>
								<span>
									Our team reviews your requirements within 24
									hours
								</span>
							</li>
							<li className='flex items-start gap-2'>
								...
								/>
								<span>
									We prepare a detailed quote with competitive
									pricing
								</span>
							</li>
							<li className='flex items-start gap-2'>
								...
								/>
								<span>
									You receive personalized guidance from our
									technical experts
								</span>
							</li>
						</ul>
						...
						>
							...
							<div className='border-t pt-6'>
								...
								<p className='text-sm text-gray-500 text-center mt-4'>
									...
									our team regarding your quote request
								</p>
							</div>
						</form>
					</div>
