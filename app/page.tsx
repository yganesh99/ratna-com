...
import { ArrowRight, CheckCircle, Globe, Package, Users, Clock } from 'lucide-react';
        ...
        <div className="container mx-auto px-4 py-20 md:py-32 relative">
          <div className="max-w-4xl">
            <h1 className="text-4xl md:text-6xl font-bold mb-6 leading-tight">
              Global Sourcing & Supply of Industrial-Grade Materials
            </h1>
            <p className="text-xl md:text-2xl text-blue-100 mb-8 leading-relaxed">
              Reliable metals, machinery, hardware, and tools for business professionals.
              Competitive pricing. On-time delivery. Technical expertise.
            </p>
        ...
        <div className="container mx-auto px-4">
          <div className="grid grid-cols-2 md:grid-cols-4 gap-8">
            <div className="text-center">
              ...
              <div className="text-gray-600 font-medium">Years in Industry</div>
            </div>
            <div className="text-center">
              <div className="text-4xl font-bold text-blue-600 mb-2">30+</div>
              <div className="text-gray-600 font-medium">Countries Sourced</div>
            </div>
            <div className="text-center">
        ...
        <div className="container mx-auto px-4">
          <div className="text-center mb-12">
            ...
            <p className="text-lg text-gray-600 max-w-2xl mx-auto">
              Comprehensive range of industrial materials and equipment sourced globally
            </p>
          </div>
        ...
        <div className="container mx-auto px-4">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8">
            <div className="text-center">
              ...
              <h3 className="font-bold text-xl mb-2">Global Sourcing</h3>
              <p className="text-gray-600">
                Access to quality materials from trusted suppliers worldwide
              </p>
            </div>
            ...
            <div className="text-center">
              ...
              <p className="text-gray-600">
                Competitive pricing for large volume requirements
              </p>
            </div>
            ...
            <div className="text-center">
              ...
              <p className="text-gray-600">
                Expert guidance on product selection and specifications
              </p>
            </div>
            ...
            <div className="text-center">
              ...
              <p className="text-gray-600">
                Efficient logistics and on-time delivery guaranteed
              </p>
            </div>
          </div>
        </div>
        ...
        <div className="container mx-auto px-4">
          <div className="text-center mb-12">
            ...
            <p className="text-lg text-gray-600">
              Serving procurement managers, engineers, and industrial buyers
            </p>
          </div>
          ...
          <div className="grid grid-cols-2 md:grid-cols-4 gap-8 items-center opacity-50">
            {[1, 2, 3, 4].map((i) => (
              ...
              >
                <span className="text-gray-400 font-semibold">Client Logo {i}</span>
              </div>
            ))}
          </div>
        </div>
      ...
      <section className="py-20 bg-gradient-to-r from-blue-600 to-blue-800 text-white">
        <div className="container mx-auto px-4 text-center">
          ...
          <p className="text-xl text-blue-100 mb-8 max-w-2xl mx-auto">
            Get a competitive quote for your industrial material requirements today
          </p>
          <Link
            href="/request-quote"
